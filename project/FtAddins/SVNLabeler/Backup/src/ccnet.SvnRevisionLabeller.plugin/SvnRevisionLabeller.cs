...
namespace CcNet.Labeller
{
    ...
    {
        private static Regex _extractVersionInfoRegex = new Regex(@"\[assembly\: AssemblyVersionAttribute\(""(\d{1,})\.(\d{1,})\.(\d{1,})\.(\d{1,})""\)\]", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.CultureInvariant);
